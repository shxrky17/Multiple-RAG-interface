...
import { Navbar } from "@/heroui/components/navbar";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
    ...
    <div>
      <nav className="bg-blue-100 border-b border-blue-200">
        <div className="max-w-screen-xl mx-auto px-4 py-3 flex justify-center items-center">
          <ul className="flex space-x-6 bg-white px-6 py-2 rounded-full shadow-sm text-sm font-medium">
            <li>
            ...
            <li>
              <Link href="/fruit" className="text-gray-800 hover:text-blue-700 transition-colors duration-200">
                Fruits
              </Link>
            </li>
            <li>
              <Link href="/Chat" className="text-gray-800 hover:text-blue-700 transition-colors duration-200">
                Chat
              </Link>
            </li>
            <li>
              <Link href="#" className="text-gray-800 hover:text-blue-700 transition-colors duration-200">
                Contact
              </Link>
            </li>
          </ul>
                ...
                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <h1 className="title-font text-lg font-medium text-gray-900 mb-3">
                      {["The Catalyzer", "The 400 Blows", "Shooting Stars"][index]}
                    </h1>
